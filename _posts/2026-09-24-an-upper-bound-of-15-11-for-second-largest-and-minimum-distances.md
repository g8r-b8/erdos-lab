...
**Update (2026-09-25).** The bound has since been improved to $$4/3$$, with $$21/16$$ outside one narrow range of parameters and a bound matching $$9/7$$ when $$\Delta-\Delta_2 > \delta$$; see [An upper bound of 4/3]({{ site.baseurl }}{% post_url 2026-09-25-an-upper-bound-of-4-3-for-second-largest-and-minimum-distances %}). Those improvements are refereed but not yet formalised in Lean; the $$15/11$$ bound here remains the formalised one.
